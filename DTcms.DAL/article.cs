...
namespace DTcms.DAL
{
	...
	public partial class article
	{
        ...
        /// 获得关健字查询分页数据(搜索用到)
        /// </summary>
        public DataSet GetSearch(string channel_name, string category_id, int pageSize, int pageIndex, string strWhere, string filedOrder, out int recordCount)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select id,channel_id,category_id,call_index,title,zhaiyao,add_time,img_url,link_url,seo_title,click from " + databaseprefix + "article");
