...
namespace DTcms.Web.UI
{
    ...
    { 
        ...
        #endregion
        public List<Model.article_attach> GetArticle_Attach(string id)
        {
            DAL.article_attach dal = new DAL.article_attach(config.sysdatabaseprefix);
            return dal.GetList(int.Parse(id));
        }
    }
}
