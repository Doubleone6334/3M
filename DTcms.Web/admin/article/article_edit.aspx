...
<div class="tab-content">
  ...
  <dl ID="div_attach_container" runat="server" visible="false">
    <dt>上传任务图片</dt>
    <dd>
      <a class="icon-btn add attach-btn"><span>添加任务图片</span></a><span class="Validform_checktip">任务请添加任务图片</span>
          ...
          <asp:Repeater ID="rptAttachList" runat="server">
            <ItemTemplate>
              <li>
                ...
                <i class="icon"></i>
                <a href="javascript:;" onclick="delAttachNode(this);" class="del" title="删除任务图片"></a>
                <a href="javascript:;" onclick="showAttachDialog(this);" class="edit" title="更新任务图片"></a>
                ...
                <div class="btns" style="display:none">下载积分：<input type="text" name="txt_attach_point" onkeydown="return checkNumber(event);" value="<%#Eval("point")%>" /></div>
              </li>
            </ItemTemplate>
          </asp:Repeater>
        </ul>
...
<div class="tab-content" style="display:none">
  ...
  <dl ID="div_source" runat="server" visible="false" style="display:none">
  ...
  <dl ID="div_author" runat="server" visible="false" style="display:none">
