...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("', '#keywords','down','52');return false};\" value=\"搜索任务序列号，如：2915\" x-webkit-speech=\"\" />\r\n        <button class=\"submit\" type=\"submit\" onclick=\"SiteSearch('");
	templateBuilder.Append(linkurl("search"));
	...
	templateBuilder.Append("" + Utils.ObjectToStr(dr["title"]) + "</span></div>\r\n							<div class=\"text\"><textarea id=\"content1\" readonly=\"readonly\">" + Utils.ObjectToStr(dr["link_url"]) + "</textarea></div>\r\n							<div class=\"btn layout\">\r\n                            ");
	...
	templateBuilder.Append("\" class=\"more-btn\" title=\"查看任务教程\">查看任务教程</a><a href=\"javascript:;\" class=\"copy-btn\" onclick=\"jsCopy(1)\" title=\"复制任务链接\">复制任务链接</a></div>\r\n							</div>\r\n						</li> \r\n                        ");
	}
	else
	{
